...
int main()
{
    ...
    for (int i = 0; i < 12; i++)
    {
        props.push_back(Prop{Vector2{(rand() % 1300 + 400) * mapScale, (rand() % 1550 + 230) * mapScale}, LoadTexture("tiles/log.png"), i});
    }

    for (int i = 13; i < 33; i++)
    {
        props.push_back(Prop{Vector2{(rand() % 1300 + 400) * mapScale, (rand() % 1610 + 230) * mapScale}, LoadTexture("tiles/rock.png"), i});
    }
